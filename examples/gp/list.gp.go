...
//#GOGP_IGNORE_BEGIN //required from(github.com/vipally/gogp/examples/gp/functorcmp)
...
//#GOGP_IGNORE_END //required from(github.com/vipally/gogp/examples/gp/functorcmp)
