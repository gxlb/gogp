...
//#GOGP_IGNORE_BEGIN ///require begin from(github.com/vipally/gogp/examples/gp/functorcmp)
...
//#GOGP_IGNORE_END ///require end from(github.com/vipally/gogp/examples/gp/functorcmp)
