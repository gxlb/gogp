...
// Last update at: [Tue Nov 22 2016 17:45:22]
// Generate from:
...
func (this *GOGGlobalNamePrefixListNodeVisitor) Get() *PersonListNode {
	return this.node
}

func (this *PersonList) Visitor() *GOGGlobalNamePrefixListNodeVisitor {
