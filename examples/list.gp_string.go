...
// Last update at: [Tue Nov 22 2016 18:37:00]
// Generate from:
...
func (this *GOGGlobalNamePrefixListNodeVisitor) Get() *StringListNode {
	return this.node
}

func (this *StringList) Visitor() *GOGGlobalNamePrefixListNodeVisitor {
